...
export const SKILLS = {
  ...
  "Backend": ["FastAPI", "Flask", "Nest.js", "Express.js", "PostgreSQL", "MongoDB", "Redis", "Microservices"],
  "Web Automation": ["Playwright", "Puppeteer", "BeautifulSoup"],
  "Infrastructure": ["Docker", "K8s", "GCP", "Terraform", "CI/CD", "Nginx", "Traefik", "HAProxy", "Grafana"],
  "Security": ["Web Security", "Network Security", "CTF"]
};
